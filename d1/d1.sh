...
plot "tmp/d1.txt" using (0.5*$2):0:(0.5*$2):(myBoxWidth/2):($0+1):ytic(1) with boxxy lc var
...
echo "████████▒▒ 80%"
xdg-open "image/d1.png"

#Suppression du fichier de script temporaire
rm "$gnuplot_script" tmp/premiere_liste tmp/d1.txt
